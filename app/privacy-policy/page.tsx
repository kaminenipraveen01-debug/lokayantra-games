  ...
  return (
    <main className="w-full min-h-screen text-black font-sans pb-12 relative overflow-hidden bg-[#cfcfcf]">
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-20px] left-[-20px] w-[200px] h-[200px] rounded-full bg-black" />
        <div className="absolute bottom-[-50px] right-[-50px] w-[250px] h-[250px] rounded-full bg-black" />
        <div className="absolute top-[40%] right-[10%] w-[120px] h-[120px] rounded-full bg-black" />
      </div>
      ...
      <div className="w-full max-w-[850px] mx-auto px-4 mt-[120px] relative z-10">
        ...
        >
          ...
          <div className="space-y-5 text-xs sm:text-sm font-semibold text-black/70 leading-relaxed border-t border-black/5 pt-4">
            ...
            <h2 className="text-sm font-black uppercase text-black tracking-wide pt-2">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-sm font-black uppercase text-black tracking-wide pt-2">2. Log Files & Analytics</h2>
            <p>
            ...
            <h2 className="text-sm font-black uppercase text-black tracking-wide pt-2">3. Cookies and Web Beacons</h2>
            <p>
            ...
            <h2 className="text-sm font-black uppercase text-black tracking-wide pt-2">10. Contact Us</h2>
            <p>
          ...
          <div className="pt-4 border-t border-black/5 flex justify-between items-center text-xs font-black uppercase">
            ...
            <Link href="/terms" className="text-black/60 hover:text-black">Terms of Service →</Link>
          </div>
        </div>
      </div>
    </main>
