...
export default function GameLoading() {
  return (
    <main className="w-full min-h-screen text-white font-sans pb-12 relative overflow-hidden select-none bg-[#0a0a0d]">
      ...
      {/* White bubbles on dark background */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-50px] left-[20%] w-[180px] h-[180px] rounded-full bg-white/10" />
        <div className="absolute top-[50px] left-[5%] w-[150px] h-[150px] rounded-full bg-white/[0.07]" />
        ...
        <div className="absolute top-[180px] left-[2%] w-[60px] h-[60px] rounded-full bg-white/[0.07]" />
        <div className="absolute top-[400px] left-[25%] w-[130px] h-[130px] rounded-full bg-white/[0.07]" />
        <div className="absolute top-[480px] right-[5%] w-[170px] h-[170px] rounded-full bg-white/[0.07]" />
        <div className="absolute top-[650px] right-[28%] w-[140px] h-[140px] rounded-full bg-white/5" />
        <div className="absolute bottom-[320px] left-[5%] w-[180px] h-[180px] rounded-full bg-white/[0.07]" />
